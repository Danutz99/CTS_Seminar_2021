...
public class PortContainer implements Cloneable, Numarabil {
	...
	public void setNrContainerePerTip(int nrContainerePerTip, TipContainer tipContainer) {
		...
		default:
			throw new RuntimeException(
					"Nu stiu sa setez nr de containere pentru PortContainerul " + this.getEticheta().toString());
	...
	public String toString() {
		return this.getClass().getName() + "," + toStringFromCharArray(this.eticheta) + ","
				+ toStringFromTipContainerArray(this.tipContainer) + toStringFromIntArray(this.nrContainere);
	}
	...
	public int getCapacitate() {
		// presupunem ca ordinea containerelor este cea din masivul tipContainer
		// [Mic_10mc,Mediu_25mc,Mare_50mc,Jumbo_100mc];
		return this.nrContainere[0] * 10 + this.nrContainere[1] * 25 + this.nrContainere[2] * 50
				+ this.nrContainere[3] * 100;
	}
