...
//                    + ": " + portContainerCuSemafor.getCapacitate());
            ...
            if (this.portContainerCuSemafor.isOperare()) {
                System.out.println("Capacitatea dan.mamaliga.tema_1.PortContainer-ului inainte de descarcare pentru tipul de container " + macara.getTipContainer().toString()
                        + ": " + portContainerCuSemafor.getCapacitate());
                System.out.println("Numarul de containere de tipul " + macara.getTipContainer().toString()+ " inainte de descarcare este " + this.portContainerCuSemafor.getNrContainerePerTip(this.macara.getTipContainer()));
                int nrContainereRamase = descarcaContainer(this.portContainerCuSemafor,this.macara);
                if (nrContainereRamase  == 0) {
                    System.out.println("Operatorul macara pentru tipul de containere: " + macara.getTipContainer().toString() + " s-a oprit la numarul de containere " + nrContainereRamase);
                ...
                System.out.println("Numarul de containere de tipul " + macara.getTipContainer().toString()+ " dupa descarcare este " + this.portContainerCuSemafor.getNrContainerePerTip(this.macara.getTipContainer()));
                System.out.println("Capacitatea dan.mamaliga.tema_1.PortContainer-ului dupa operare descarcare pentru tipul de container: " + macara.getTipContainer().toString() + ": " + portContainerCuSemafor.getCapacitate());
                System.out.println();
                this.portContainerCuSemafor.elibereazaOperare();
            }
            else {
                System.out.println("Operatorul macara pentru tipul de container " + macara.getTipContainer().toString() + " este in asteptare!");
                System.out.println();
            }
            }
    }
